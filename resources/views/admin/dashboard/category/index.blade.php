                                        ...
                                        <div class="modal-body">
                                            <form action="{{route('category.store')}}" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @error('name_category') is-invalid @enderror" id="name_category" name="name_category" value="{{ old('name_category') }}" placeholder="Nike">
                                                    @error('name_category')
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{$item->name_category}}</td>
                                    <td class="text-right">
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal{{$loop->iteration}}">Edit</button>
                                            <div id="myModal{{$loop->iteration}}" class="modal fade" tabindex="-1" role="dialog"
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="{{ url('category/'.$item->id) }}" method="POST">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label>Name Category</label>
                                                                        <input type="text" class="form-control
                                                                        @error('name_category') is-invalid @enderror" id="name_category" name="name_category" value="{{ old('name_category') ?? $item->name_category}}" placeholder="Nike">
                                                                        @error('name_category')
                                                                            <div class="text-danger">{{ $message }}</div>
                                                                        @enderror
                                                                    </div>
                                                ...
                                                <form action="{{ route('category.destroy', ['category' => $item->id]) }}" method="POST" class="d-inline-block">
                                                    @method('DELETE')
                                                    @csrf
